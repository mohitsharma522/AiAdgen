...
export default function Hero() {
    ...
    const mainImageUrl = 'https://images.unsplash.com/photo-1690378820474-b468b8ee64d3?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8aXQlMjB0ZWFtfGVufDB8fDB8fHww';

    const galleryStripImages = [
        'https://plus.unsplash.com/premium_photo-1661429002035-1a48a1f78cf6?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8d29yayUyMHRvZ2V0aGVyfGVufDB8fDB8fHww',
        'https://images.unsplash.com/photo-1690378820474-b468b8ee64d3?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8aXQlMjB0ZWFtfGVufDB8fDB8fHww',
                ...
                <div className="max-w-6xl mx-auto px-4 min-h-screen max-md:w-screen max-md:overflow-hidden pt-32 md:pt-26 flex items-center justify-center">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                        <div className="text-left">
                            ...
                            >
                               Upload a product images and a model photo  - our AI instantly produces professional lifestyle imagery and short-forms videos optimized for commercials Reels.
                            </motion.p>
